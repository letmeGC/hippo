...
class TplModel_Choice extends TplModel_Base
{
	protected  $FieldArr = array(
	 	'id'=>'ID',
	 	'name'=>'spec name',
	 	'type'=>'type',//(1:数量 2:颜色)
	 	'param'=>'spec desciption',
	);
    ...
    public function desc(){
		...
		foreach ($desc as $key => $value) {
			...
			}else
			{
				...
				elseif(array_key_exists($value['Field'] , $this->FieldTypeSelect))
				{
	...
	{
		require_once "Models/Model_Choice.php";
		Model_Choice::delete("id=?",array($id));
	}
